  ...
  return (
    <section id="about">
      ...
      >
        ...
        <p className="text-xl md:text-2xl mb-11">
          Après une expérience enrichissante dans le monde de la relation client
          et dans laquelle j'ai acquis beaucoup de connaissances (Qualité,
        ...
        <Alert color="info" severity="info">
          ...
          <p className="font-bold text-xl md:text-2xl">
            Je suis actuellement à la recherche d'un stage, d'un emploi pour
            acquérir de l'expérience dans le domaine, avec une préférence pour
            le Front End.
          </p>
          <p className="text-xl md:text-2xl">
            (Vous êtes recruteur et vous avez la possibilité de me former sur
            une nouvelle techno ? Contactez-moi !)
          </p>
        </Alert>
      </motion.div>
    </section>
